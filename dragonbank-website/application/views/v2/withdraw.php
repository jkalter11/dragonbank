...
?>
							<div id="my-money">
								...
								<div id="sub-nav">
									<a href="/profile/deposit<?= $get; ?>" class="btn btn-primary btn-xs">Deposit</a>
									<a href="/profile/withdraw<?= $get; ?>" class="btn btn-danger btn-xs">Withdraw</a>
									<a href="/profile/history<?= $get; ?>" class="btn btn-primary btn-xs">History</a>
									<a href="/profile/wishlist<?= $get; ?>" class="btn btn-primary btn-xs">Wishlist</a>
								</div>
							...
							<form class="form-horizontal default-form my-money-form" role="form" method="POST">
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="col-content clearfix">
											<div class="form-group">
												<label for="amount" class="col-sm-6 control-label" style="padding-top: 2px">Amount to Withdraw</label>
									...
									<div class="col-sm-4">
										<div class="col-content clearfix">
											<div class="form-group">
												<label for="bank-allocations" class="col-sm-6 control-label">Withdraw from</label>
												<div class="col-sm-6 no-h-padding">
									...
									<div class="col-sm-4">
										<div class="col-content clearfix">
											<div class="form-group">
												<label for="reason" class="col-sm-6 control-label" style="padding-top: 2px">Reason for Withdraw</label>
												<div class="col-sm-6 no-h-padding">
