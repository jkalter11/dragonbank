...
?>
							<div id="sub-nav">
								...
								<a href="/profile/withdraw<?= $get; ?>" class="btn btn-primary btn-xs">Withdraw</a>
								<a href="/profile/history<?= $get; ?>" class="btn btn-primary btn-xs">History</a>
								<a href="/profile/wishlist<?= $get; ?>" class="btn btn-danger btn-xs">Wishlist</a>
							</div>
...
?>
							...
							<div class="top-margin">
								<a href="/profile/wishlist/export<?=$get?>" class="btn btn-warning">Export</a>
