...
?>
													...
													<div class="col-sm-5">
														<a href="/new/signup" class="btn btn-primary">Add a new child</a>
													</div>
												</div>
											</div>
										</div>
...
?>							
							<div class="select-child-panel-div" id="child-panel<?=$k?>" style="<?php echo ( ($k == 0 && !isset($curChild)) || (isset($curChild) && $curChild == $v['child_id']) )? 'display:block' : 'display:none'; ?>">
								<div class="text-center">
									<a href="/new/profile/profile?child_id=<?= $v['child_id']; ?>" class="btn btn-warning" style="margin-bottom: 5px;">Manage Money</a><br>
